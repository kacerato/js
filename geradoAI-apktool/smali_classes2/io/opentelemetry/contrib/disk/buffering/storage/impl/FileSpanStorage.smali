.class public final Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileSpanStorage;
.super Ljava/lang/Object;
.source ""

# interfaces
.implements Lio/opentelemetry/contrib/disk/buffering/storage/SignalStorage$Span;
...
.method private constructor <init>(Lio/opentelemetry/contrib/disk/buffering/internal/storage/FileSignalStorage;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileSpanStorage;->fileSignalStorage:Lio/opentelemetry/contrib/disk/buffering/internal/storage/FileSignalStorage;
...
.method public static create(Ljava/io/File;)Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileSpanStorage;
    .locals 1
    ...
    invoke-static {p0, v0}, Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileSpanStorage;->create(Ljava/io/File;Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileStorageConfiguration;)Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileSpanStorage;
...
.method public static create(Ljava/io/File;Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileStorageConfiguration;)Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileSpanStorage;
    .locals 3
    ...
    .line 4
    new-instance p0, Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileSpanStorage;

    new-instance p1, Lio/opentelemetry/contrib/disk/buffering/internal/storage/FileSignalStorage;

    .line 5
    invoke-static {}, Lio/opentelemetry/contrib/disk/buffering/internal/serialization/serializers/SignalSerializer;->ofSpans()Lio/opentelemetry/contrib/disk/buffering/internal/serialization/serializers/SignalSerializer;

    move-result-object v1

    invoke-static {}, Lio/opentelemetry/contrib/disk/buffering/internal/serialization/deserializers/SignalDeserializer;->ofSpans()Lio/opentelemetry/contrib/disk/buffering/internal/serialization/deserializers/SignalDeserializer;
    ...
    invoke-direct {p0, p1}, Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileSpanStorage;-><init>(Lio/opentelemetry/contrib/disk/buffering/internal/storage/FileSignalStorage;)V
...
.method public clear()Ljava/util/concurrent/CompletableFuture;
    ...
    .line 1
    iget-object v0, p0, Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileSpanStorage;->fileSignalStorage:Lio/opentelemetry/contrib/disk/buffering/internal/storage/FileSignalStorage;
