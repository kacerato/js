.class public final Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileMetricStorage;
.super Ljava/lang/Object;
.source ""

# interfaces
.implements Lio/opentelemetry/contrib/disk/buffering/storage/SignalStorage$Metric;
...
.method private constructor <init>(Lio/opentelemetry/contrib/disk/buffering/internal/storage/FileSignalStorage;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileMetricStorage;->fileSignalStorage:Lio/opentelemetry/contrib/disk/buffering/internal/storage/FileSignalStorage;
...
.method public static create(Ljava/io/File;)Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileMetricStorage;
    .locals 1
    ...
    invoke-static {p0, v0}, Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileMetricStorage;->create(Ljava/io/File;Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileStorageConfiguration;)Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileMetricStorage;
...
.method public static create(Ljava/io/File;Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileStorageConfiguration;)Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileMetricStorage;
    .locals 3
    ...
    .line 4
    new-instance p0, Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileMetricStorage;

    new-instance p1, Lio/opentelemetry/contrib/disk/buffering/internal/storage/FileSignalStorage;

    .line 5
    invoke-static {}, Lio/opentelemetry/contrib/disk/buffering/internal/serialization/serializers/SignalSerializer;->ofMetrics()Lio/opentelemetry/contrib/disk/buffering/internal/serialization/serializers/SignalSerializer;

    move-result-object v1

    invoke-static {}, Lio/opentelemetry/contrib/disk/buffering/internal/serialization/deserializers/SignalDeserializer;->ofMetrics()Lio/opentelemetry/contrib/disk/buffering/internal/serialization/deserializers/SignalDeserializer;
    ...
    invoke-direct {p0, p1}, Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileMetricStorage;-><init>(Lio/opentelemetry/contrib/disk/buffering/internal/storage/FileSignalStorage;)V
...
.method public clear()Ljava/util/concurrent/CompletableFuture;
    ...
    .line 1
    iget-object v0, p0, Lio/opentelemetry/contrib/disk/buffering/storage/impl/FileMetricStorage;->fileSignalStorage:Lio/opentelemetry/contrib/disk/buffering/internal/storage/FileSignalStorage;
