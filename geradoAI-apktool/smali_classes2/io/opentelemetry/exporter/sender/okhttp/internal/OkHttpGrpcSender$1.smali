...
.method public onFailure(Lx/cc;Ljava/io/IOException;)V
    ...
    .line 1
    iget-object p1, p0, Lio/opentelemetry/exporter/sender/okhttp/internal/OkHttpGrpcSender$1;->val$onError:Ljava/util/function/Consumer;
...
.method public onResponse(Lx/cc;Lx/gu0;)V
    ...
    .line 1
    :try_start_0
    iget-object p1, p2, Lx/gu0;->p:Lx/iu0;

    .line 2
    .line 3
    invoke-virtual {p1}, Lx/iu0;->a()[B
    :try_end_0
    ...
    .line 5
    .line 6
    invoke-static {p2}, Lio/opentelemetry/exporter/sender/okhttp/internal/OkHttpGrpcSender;->access$000(Lx/gu0;)Ljava/lang/String;
    ...
    .line 10
    invoke-static {p2}, Lio/opentelemetry/exporter/sender/okhttp/internal/OkHttpGrpcSender;->access$100(Lx/gu0;)Ljava/lang/String;
    ...
    .line 20
    :goto_0
    iget-object v0, p0, Lio/opentelemetry/exporter/sender/okhttp/internal/OkHttpGrpcSender$1;->val$onResponse:Ljava/util/function/Consumer;
    ...
    .line 31
    iget-object p2, p0, Lio/opentelemetry/exporter/sender/okhttp/internal/OkHttpGrpcSender$1;->val$onError:Ljava/util/function/Consumer;
    ...
    .line 34
    .line 35
    const-string v1, "Could not consume server response"
