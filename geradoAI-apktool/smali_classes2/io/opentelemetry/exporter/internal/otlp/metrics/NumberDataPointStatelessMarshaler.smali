.class final Lio/opentelemetry/exporter/internal/otlp/metrics/NumberDataPointStatelessMarshaler;
...
# static fields
.field static final INSTANCE:Lio/opentelemetry/exporter/internal/otlp/metrics/NumberDataPointStatelessMarshaler;
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lio/opentelemetry/exporter/internal/otlp/metrics/NumberDataPointStatelessMarshaler;

    .line 2
    .line 3
    invoke-direct {v0}, Lio/opentelemetry/exporter/internal/otlp/metrics/NumberDataPointStatelessMarshaler;-><init>()V

    .line 4
    .line 5
    .line 6
    sput-object v0, Lio/opentelemetry/exporter/internal/otlp/metrics/NumberDataPointStatelessMarshaler;->INSTANCE:Lio/opentelemetry/exporter/internal/otlp/metrics/NumberDataPointStatelessMarshaler;
...
# virtual methods
.method public getBinarySerializedSize(Lio/opentelemetry/sdk/metrics/data/PointData;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)I
    .locals 4
    ...
    .line 4
    sget-object v1, Lio/opentelemetry/proto/metrics/v1/internal/NumberDataPoint;->TIME_UNIX_NANO:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;
    ...
    .line 5
    invoke-static {p1}, Lio/opentelemetry/exporter/internal/otlp/metrics/NumberDataPointMarshaler;->toProtoPointValueType(Lio/opentelemetry/sdk/metrics/data/PointData;)Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;

    move-result-object v0

    .line 6
    sget-object v2, Lio/opentelemetry/proto/metrics/v1/internal/NumberDataPoint;->AS_INT:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;
    ...
    invoke-interface {v2}, Lio/opentelemetry/sdk/metrics/data/LongPointData;->getValue()J

    move-result-wide v2

    invoke-static {v0, v2, v3}, Lio/opentelemetry/exporter/internal/marshal/MarshalerUtil;->sizeFixed64Optional(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;J)I
    ...
    invoke-interface {v2}, Lio/opentelemetry/sdk/metrics/data/DoublePointData;->getValue()D

    move-result-wide v2

    invoke-static {v0, v2, v3}, Lio/opentelemetry/exporter/internal/marshal/MarshalerUtil;->sizeDoubleOptional(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;D)I
    ...
    .line 9
    :goto_1
    sget-object v1, Lio/opentelemetry/proto/metrics/v1/internal/NumberDataPoint;->EXEMPLARS:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;
    ...
    sget-object v3, Lio/opentelemetry/exporter/internal/otlp/metrics/ExemplarStatelessMarshaler;->INSTANCE:Lio/opentelemetry/exporter/internal/otlp/metrics/ExemplarStatelessMarshaler;
...
.method public bridge synthetic getBinarySerializedSize(Ljava/lang/Object;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)I
    ...
    invoke-virtual {p0, p1, p2}, Lio/opentelemetry/exporter/internal/otlp/metrics/NumberDataPointStatelessMarshaler;->getBinarySerializedSize(Lio/opentelemetry/sdk/metrics/data/PointData;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)I
...
.method public writeTo(Lio/opentelemetry/exporter/internal/marshal/Serializer;Lio/opentelemetry/sdk/metrics/data/PointData;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)V
    .locals 3
    ...
    .line 4
    invoke-static {p2}, Lio/opentelemetry/exporter/internal/otlp/metrics/NumberDataPointMarshaler;->toProtoPointValueType(Lio/opentelemetry/sdk/metrics/data/PointData;)Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;
    ...
    .line 9
    invoke-interface {p2}, Lio/opentelemetry/sdk/metrics/data/PointData;->getExemplars()Ljava/util/List;
...
.method public bridge synthetic writeTo(Lio/opentelemetry/exporter/internal/marshal/Serializer;Ljava/lang/Object;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lio/opentelemetry/exporter/internal/otlp/metrics/NumberDataPointStatelessMarshaler;->writeTo(Lio/opentelemetry/exporter/internal/marshal/Serializer;Lio/opentelemetry/sdk/metrics/data/PointData;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)V
