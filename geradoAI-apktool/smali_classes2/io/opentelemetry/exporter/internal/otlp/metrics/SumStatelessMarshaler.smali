...
.method public getBinarySerializedSize(Lio/opentelemetry/sdk/metrics/data/SumData;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)I
    ...
    sget-object v2, Lio/opentelemetry/exporter/internal/otlp/metrics/NumberDataPointStatelessMarshaler;->INSTANCE:Lio/opentelemetry/exporter/internal/otlp/metrics/NumberDataPointStatelessMarshaler;

    sget-object v3, Lio/opentelemetry/exporter/internal/otlp/metrics/SumStatelessMarshaler;->DATA_POINT_SIZE_CALCULATOR_KEY:Lio/opentelemetry/exporter/internal/marshal/MarshalerContext$Key;
    ...
    invoke-static {v1}, Lio/opentelemetry/exporter/internal/otlp/metrics/MetricsMarshalerUtil;->mapToTemporality(Lio/opentelemetry/sdk/metrics/data/AggregationTemporality;)Lio/opentelemetry/exporter/internal/marshal/ProtoEnumInfo;
    ...
    .line 8
    sget-object p2, Lio/opentelemetry/proto/metrics/v1/internal/Sum;->IS_MONOTONIC:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;

    invoke-interface {p1}, Lio/opentelemetry/sdk/metrics/data/SumData;->isMonotonic()Z

    move-result p1

    invoke-static {p2, p1}, Lio/opentelemetry/exporter/internal/marshal/MarshalerUtil;->sizeBool(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;Z)I
...
.method public writeTo(Lio/opentelemetry/exporter/internal/marshal/Serializer;Lio/opentelemetry/sdk/metrics/data/SumData;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)V
    ...
    .line 5
    sget-object p1, Lio/opentelemetry/proto/metrics/v1/internal/Sum;->AGGREGATION_TEMPORALITY:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;
    ...
    invoke-static {p3}, Lio/opentelemetry/exporter/internal/otlp/metrics/MetricsMarshalerUtil;->mapToTemporality(Lio/opentelemetry/sdk/metrics/data/AggregationTemporality;)Lio/opentelemetry/exporter/internal/marshal/ProtoEnumInfo;

    move-result-object p3

    .line 7
    invoke-virtual {v0, p1, p3}, Lio/opentelemetry/exporter/internal/marshal/Serializer;->serializeEnum(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;Lio/opentelemetry/exporter/internal/marshal/ProtoEnumInfo;)V

    .line 8
    sget-object p1, Lio/opentelemetry/proto/metrics/v1/internal/Sum;->IS_MONOTONIC:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;

    invoke-interface {p2}, Lio/opentelemetry/sdk/metrics/data/SumData;->isMonotonic()Z

    move-result p2

    invoke-virtual {v0, p1, p2}, Lio/opentelemetry/exporter/internal/marshal/Serializer;->serializeBool(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;Z)V
