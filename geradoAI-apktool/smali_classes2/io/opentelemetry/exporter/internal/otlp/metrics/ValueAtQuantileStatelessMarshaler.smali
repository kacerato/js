...
.method public getBinarySerializedSize(Lio/opentelemetry/sdk/metrics/data/ValueAtQuantile;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)I
    ...
    invoke-static {v0, v1, p1, p2}, Lio/opentelemetry/exporter/internal/otlp/metrics/ValueAtQuantileMarshaler;->calculateSize(DD)I
...
.method public writeTo(Lio/opentelemetry/exporter/internal/marshal/Serializer;Lio/opentelemetry/sdk/metrics/data/ValueAtQuantile;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)V
    ...
    .line 2
    sget-object p3, Lio/opentelemetry/proto/metrics/v1/internal/SummaryDataPoint$ValueAtQuantile;->QUANTILE:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;

    invoke-interface {p2}, Lio/opentelemetry/sdk/metrics/data/ValueAtQuantile;->getQuantile()D

    move-result-wide v0

    invoke-virtual {p1, p3, v0, v1}, Lio/opentelemetry/exporter/internal/marshal/Serializer;->serializeDouble(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;D)V

    .line 3
    sget-object p3, Lio/opentelemetry/proto/metrics/v1/internal/SummaryDataPoint$ValueAtQuantile;->VALUE:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;
