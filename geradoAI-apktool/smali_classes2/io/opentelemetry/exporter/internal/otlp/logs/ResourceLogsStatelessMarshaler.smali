.class public final Lio/opentelemetry/exporter/internal/otlp/logs/ResourceLogsStatelessMarshaler;
...
# static fields
.field static final INSTANCE:Lio/opentelemetry/exporter/internal/otlp/logs/ResourceLogsStatelessMarshaler;

.field private static final SCOPE_LOG_SIZE_CALCULATOR_KEY:Lio/opentelemetry/exporter/internal/marshal/MarshalerContext$Key;

.field private static final SCOPE_LOG_WRITER_KEY:Lio/opentelemetry/exporter/internal/marshal/MarshalerContext$Key;
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lio/opentelemetry/exporter/internal/otlp/logs/ResourceLogsStatelessMarshaler;

    .line 2
    .line 3
    invoke-direct {v0}, Lio/opentelemetry/exporter/internal/otlp/logs/ResourceLogsStatelessMarshaler;-><init>()V

    .line 4
    .line 5
    .line 6
    sput-object v0, Lio/opentelemetry/exporter/internal/otlp/logs/ResourceLogsStatelessMarshaler;->INSTANCE:Lio/opentelemetry/exporter/internal/otlp/logs/ResourceLogsStatelessMarshaler;
    ...
    .line 12
    sput-object v0, Lio/opentelemetry/exporter/internal/otlp/logs/ResourceLogsStatelessMarshaler;->SCOPE_LOG_WRITER_KEY:Lio/opentelemetry/exporter/internal/marshal/MarshalerContext$Key;
    ...
    .line 18
    sput-object v0, Lio/opentelemetry/exporter/internal/otlp/logs/ResourceLogsStatelessMarshaler;->SCOPE_LOG_SIZE_CALCULATOR_KEY:Lio/opentelemetry/exporter/internal/marshal/MarshalerContext$Key;
...
.method public getBinarySerializedSize(Lio/opentelemetry/sdk/resources/Resource;Ljava/util/Map;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)I
    ...
    .line 4
    sget-object v1, Lio/opentelemetry/proto/logs/v1/internal/ResourceLogs;->RESOURCE:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;
    ...
    .line 5
    sget-object v1, Lio/opentelemetry/proto/logs/v1/internal/ResourceLogs;->SCOPE_LOGS:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;

    sget-object v2, Lio/opentelemetry/exporter/internal/otlp/logs/InstrumentationScopeLogsStatelessMarshaler;->INSTANCE:Lio/opentelemetry/exporter/internal/otlp/logs/InstrumentationScopeLogsStatelessMarshaler;

    sget-object v3, Lio/opentelemetry/exporter/internal/otlp/logs/ResourceLogsStatelessMarshaler;->SCOPE_LOG_SIZE_CALCULATOR_KEY:Lio/opentelemetry/exporter/internal/marshal/MarshalerContext$Key;
...
.method public bridge synthetic getBinarySerializedSize(Ljava/lang/Object;Ljava/lang/Object;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)I
    ...
    invoke-virtual {p0, p1, p2, p3}, Lio/opentelemetry/exporter/internal/otlp/logs/ResourceLogsStatelessMarshaler;->getBinarySerializedSize(Lio/opentelemetry/sdk/resources/Resource;Ljava/util/Map;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)I
...
.method public writeTo(Lio/opentelemetry/exporter/internal/marshal/Serializer;Lio/opentelemetry/sdk/resources/Resource;Ljava/util/Map;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)V
    ...
    .line 4
    sget-object v3, Lio/opentelemetry/proto/logs/v1/internal/ResourceLogs;->SCOPE_LOGS:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;

    sget-object v5, Lio/opentelemetry/exporter/internal/otlp/logs/InstrumentationScopeLogsStatelessMarshaler;->INSTANCE:Lio/opentelemetry/exporter/internal/otlp/logs/InstrumentationScopeLogsStatelessMarshaler;

    sget-object v7, Lio/opentelemetry/exporter/internal/otlp/logs/ResourceLogsStatelessMarshaler;->SCOPE_LOG_WRITER_KEY:Lio/opentelemetry/exporter/internal/marshal/MarshalerContext$Key;
    ...
    .line 5
    sget-object p1, Lio/opentelemetry/proto/logs/v1/internal/ResourceLogs;->SCHEMA_URL:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;
...
.method public bridge synthetic writeTo(Lio/opentelemetry/exporter/internal/marshal/Serializer;Ljava/lang/Object;Ljava/lang/Object;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lio/opentelemetry/exporter/internal/otlp/logs/ResourceLogsStatelessMarshaler;->writeTo(Lio/opentelemetry/exporter/internal/marshal/Serializer;Lio/opentelemetry/sdk/resources/Resource;Ljava/util/Map;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)V
