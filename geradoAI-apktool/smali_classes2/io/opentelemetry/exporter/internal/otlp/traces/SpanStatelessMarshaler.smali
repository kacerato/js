...
.method public getBinarySerializedSize(Lio/opentelemetry/sdk/trace/data/SpanData;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)I
    ...
    .line 3
    sget-object v1, Lio/opentelemetry/proto/trace/v1/internal/Span;->SPAN_ID:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;
    ...
    .line 6
    sget-object v2, Lio/opentelemetry/proto/trace/v1/internal/Span;->TRACE_STATE:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;

    invoke-static {v2, v0}, Lio/opentelemetry/exporter/internal/marshal/MarshalerUtil;->sizeBytes(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;[B)I
    ...
    .line 8
    :goto_0
    sget-object v2, Lio/opentelemetry/proto/trace/v1/internal/Span;->PARENT_SPAN_ID:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;

    invoke-static {v2, v1}, Lio/opentelemetry/exporter/internal/marshal/MarshalerUtil;->sizeSpanId(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;Ljava/lang/String;)I
    ...
    .line 10
    sget-object v1, Lio/opentelemetry/proto/trace/v1/internal/Span;->KIND:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;

    invoke-interface {p1}, Lio/opentelemetry/sdk/trace/data/SpanData;->getKind()Lio/opentelemetry/api/trace/SpanKind;

    move-result-object v2

    invoke-static {v2}, Lio/opentelemetry/exporter/internal/otlp/traces/SpanMarshaler;->toProtoSpanKind(Lio/opentelemetry/api/trace/SpanKind;)Lio/opentelemetry/exporter/internal/marshal/ProtoEnumInfo;

    move-result-object v2

    invoke-static {v1, v2}, Lio/opentelemetry/exporter/internal/marshal/MarshalerUtil;->sizeEnum(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;Lio/opentelemetry/exporter/internal/marshal/ProtoEnumInfo;)I
    ...
    invoke-static {v0, v2, v3}, Lio/opentelemetry/exporter/internal/marshal/MarshalerUtil;->sizeFixed64(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;J)I
    ...
    .line 12
    sget-object v1, Lio/opentelemetry/proto/trace/v1/internal/Span;->END_TIME_UNIX_NANO:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;

    invoke-interface {p1}, Lio/opentelemetry/sdk/trace/data/SpanData;->getEndEpochNanos()J

    move-result-wide v2

    invoke-static {v1, v2, v3}, Lio/opentelemetry/exporter/internal/marshal/MarshalerUtil;->sizeFixed64(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;J)I
    ...
    invoke-interface {v2}, Lio/opentelemetry/api/common/Attributes;->size()I
    ...
    .line 17
    sget-object v2, Lio/opentelemetry/proto/trace/v1/internal/Span;->DROPPED_ATTRIBUTES_COUNT:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;

    invoke-static {v2, v1}, Lio/opentelemetry/exporter/internal/marshal/MarshalerUtil;->sizeUInt32(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;I)I
    ...
    sget-object v3, Lio/opentelemetry/exporter/internal/otlp/traces/SpanEventStatelessMarshaler;->INSTANCE:Lio/opentelemetry/exporter/internal/otlp/traces/SpanEventStatelessMarshaler;

    .line 20
    invoke-static {v0, v2, v3, p2}, Lio/opentelemetry/exporter/internal/marshal/StatelessMarshalerUtil;->sizeRepeatedMessageWithContext(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;Ljava/util/List;Lio/opentelemetry/exporter/internal/marshal/StatelessMarshaler;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)I
    ...
    .line 22
    sget-object v2, Lio/opentelemetry/proto/trace/v1/internal/Span;->DROPPED_EVENTS_COUNT:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;
    ...
    sget-object v3, Lio/opentelemetry/exporter/internal/otlp/traces/SpanLinkStatelessMarshaler;->INSTANCE:Lio/opentelemetry/exporter/internal/otlp/traces/SpanLinkStatelessMarshaler;
    ...
    .line 27
    sget-object v2, Lio/opentelemetry/proto/trace/v1/internal/Span;->DROPPED_LINKS_COUNT:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;
    ...
    sget-object v3, Lio/opentelemetry/exporter/internal/otlp/traces/SpanStatusStatelessMarshaler;->INSTANCE:Lio/opentelemetry/exporter/internal/otlp/traces/SpanStatusStatelessMarshaler;

    .line 30
    invoke-static {v0, v2, v3, p2}, Lio/opentelemetry/exporter/internal/marshal/StatelessMarshalerUtil;->sizeMessageWithContext(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;Ljava/lang/Object;Lio/opentelemetry/exporter/internal/marshal/StatelessMarshaler;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)I
    ...
    .line 33
    invoke-static {v1, p1}, Lio/opentelemetry/exporter/internal/otlp/traces/SpanFlags;->withParentIsRemoteFlags(Lio/opentelemetry/api/trace/TraceFlags;Z)I

    move-result p1

    .line 34
    invoke-static {v0, p1}, Lio/opentelemetry/exporter/internal/marshal/MarshalerUtil;->sizeFixed32(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;I)I
...
.method public writeTo(Lio/opentelemetry/exporter/internal/marshal/Serializer;Lio/opentelemetry/sdk/trace/data/SpanData;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)V
    ...
    invoke-virtual {p1, v1, v0, p3}, Lio/opentelemetry/exporter/internal/marshal/Serializer;->serializeSpanId(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;Ljava/lang/String;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)V
    ...
    invoke-virtual {p1, v1, v0}, Lio/opentelemetry/exporter/internal/marshal/Serializer;->serializeUInt32(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;I)V
    ...
    .line 19
    invoke-virtual {p1, v0, v1, v2, p3}, Lio/opentelemetry/exporter/internal/marshal/Serializer;->serializeRepeatedMessageWithContext(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;Ljava/util/List;Lio/opentelemetry/exporter/internal/marshal/StatelessMarshaler;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)V
    ...
    .line 29
    invoke-virtual {p1, v0, v1, v2, p3}, Lio/opentelemetry/exporter/internal/marshal/Serializer;->serializeMessageWithContext(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;Ljava/lang/Object;Lio/opentelemetry/exporter/internal/marshal/StatelessMarshaler;Lio/opentelemetry/exporter/internal/marshal/MarshalerContext;)V

    .line 30
    sget-object p3, Lio/opentelemetry/proto/trace/v1/internal/Span;->FLAGS:Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;
    ...
    .line 32
    invoke-static {v0, p2}, Lio/opentelemetry/exporter/internal/otlp/traces/SpanFlags;->withParentIsRemoteFlags(Lio/opentelemetry/api/trace/TraceFlags;Z)I

    move-result p2

    .line 33
    invoke-virtual {p1, p3, p2}, Lio/opentelemetry/exporter/internal/marshal/Serializer;->serializeFixed32(Lio/opentelemetry/exporter/internal/marshal/ProtoFieldInfo;I)V
