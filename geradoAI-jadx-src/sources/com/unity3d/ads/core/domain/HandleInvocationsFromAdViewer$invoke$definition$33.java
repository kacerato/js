...
public final class HandleInvocationsFromAdViewer$invoke$definition$33 extends nb0 implements g10<ExposedFunction> {
    ...
    public final ExposedFunction invoke() {
        return CommonAdViewerExposedFunctionsKt.omImpression((OmImpressionOccurred) this.this$0.getServiceProvider().getRegistry().getService("", qs0.m7995a(OmImpressionOccurred.class)), this.$adObject);
    }
}
