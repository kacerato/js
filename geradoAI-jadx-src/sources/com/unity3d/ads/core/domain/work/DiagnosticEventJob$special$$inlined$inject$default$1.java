...
public final class DiagnosticEventJob$special$$inlined$inject$default$1 extends nb0 implements g10<GetRequestPolicy> {
    ...
    public final GetRequestPolicy invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, qs0.m7995a(GetRequestPolicy.class));
    }
}
