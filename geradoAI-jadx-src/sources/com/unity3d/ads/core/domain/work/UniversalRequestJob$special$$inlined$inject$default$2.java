...
public final class UniversalRequestJob$special$$inlined$inject$default$2 extends nb0 implements g10<UniversalRequestDataSource> {
    ...
    public final UniversalRequestDataSource invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, qs0.m7995a(UniversalRequestDataSource.class));
    }
}
