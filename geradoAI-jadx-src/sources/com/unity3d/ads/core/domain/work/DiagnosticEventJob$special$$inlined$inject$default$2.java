...
public final class DiagnosticEventJob$special$$inlined$inject$default$2 extends nb0 implements g10<DiagnosticEventRequestWorkModifier> {
    ...
    public final DiagnosticEventRequestWorkModifier invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, qs0.m7995a(DiagnosticEventRequestWorkModifier.class));
    }
}
