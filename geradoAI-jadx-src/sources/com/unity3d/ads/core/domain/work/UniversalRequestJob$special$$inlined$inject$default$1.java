...
public final class UniversalRequestJob$special$$inlined$inject$default$1 extends nb0 implements g10<UniversalRequestEventSender> {
    ...
    public final UniversalRequestEventSender invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, qs0.m7995a(UniversalRequestEventSender.class));
    }
}
