...
public final class WebviewConfigurationStore {
    ...
    /* JADX INFO: renamed from: com.unity3d.ads.datastore.WebviewConfigurationStore$1 */
    ...
    public static final class WebViewConfigurationStore extends GeneratedMessageLite<WebViewConfigurationStore, Builder> implements WebViewConfigurationStoreOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<WebViewConfigurationStore, Builder> implements WebViewConfigurationStoreOrBuilder {
            public /* synthetic */ Builder(C08241 c08241) {
                this();
            }
        ...
        public static WebViewConfigurationStore parseDelimitedFrom(InputStream inputStream) {
            return (WebViewConfigurationStore) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
        }

        public static WebViewConfigurationStore parseFrom(ByteBuffer byteBuffer) {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            C08241 c08241 = null;
            switch (C08241.f1786xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                    return new WebViewConfigurationStore();
                case 2:
                    return new Builder(c08241);
                case 3:
        ...
        public static WebViewConfigurationStore parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        ...
        public static WebViewConfigurationStore parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
            return (WebViewConfigurationStore) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, extensionRegistryLite);
        }

        public static WebViewConfigurationStore parseFrom(ByteString byteString) {
            return (WebViewConfigurationStore) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString);
        }

        public static WebViewConfigurationStore parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
            return (WebViewConfigurationStore) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, extensionRegistryLite);
        }

        public static WebViewConfigurationStore parseFrom(byte[] bArr) {
            return (WebViewConfigurationStore) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
        }

        public static WebViewConfigurationStore parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
            return (WebViewConfigurationStore) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, extensionRegistryLite);
        }

        public static WebViewConfigurationStore parseFrom(InputStream inputStream) {
            return (WebViewConfigurationStore) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
        }

        public static WebViewConfigurationStore parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
            return (WebViewConfigurationStore) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
        }

        public static WebViewConfigurationStore parseFrom(CodedInputStream codedInputStream) {
            return (WebViewConfigurationStore) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, codedInputStream);
        }

        public static WebViewConfigurationStore parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
