...
public final class UnityAdsSDK$fetchToken$$inlined$inject$default$1 extends nb0 implements g10<GetHeaderBiddingToken> {
    ...
    public final GetHeaderBiddingToken invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, qs0.m7995a(GetHeaderBiddingToken.class));
    }
}
