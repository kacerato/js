...
public final class UnityAdsSDK$initialize$$inlined$inject$default$4 extends nb0 implements g10<InitializeBoldSDK> {
    final /* synthetic */ String $named;
    final /* synthetic */ IServiceComponent $this_inject;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UnityAdsSDK$initialize$$inlined$inject$default$4(IServiceComponent iServiceComponent, String str) {
        super(0);
    ...
    public final InitializeBoldSDK invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, qs0.m7995a(InitializeBoldSDK.class));
    }
}
