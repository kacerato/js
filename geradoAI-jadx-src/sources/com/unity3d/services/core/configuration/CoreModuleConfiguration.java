...
public class CoreModuleConfiguration implements IModuleConfiguration {
    ...
    /* JADX INFO: renamed from: com.unity3d.services.core.configuration.CoreModuleConfiguration$3 */
    public static /* synthetic */ class C09273 {
    ...
    public boolean initErrorState(Configuration configuration, ErrorState errorState, final String str) {
        ...
        SDKMetrics.setConfiguration(configuration);
        int i = C09273.$SwitchMap$com$unity3d$services$core$configuration$ErrorState[errorState.ordinal()];
        if (i == 1) {
