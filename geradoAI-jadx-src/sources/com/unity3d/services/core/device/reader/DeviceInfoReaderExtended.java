...
public class DeviceInfoReaderExtended implements IDeviceInfoReader {
    ...
    public Map<String, Object> getDeviceInfoData() {
        ...
        deviceInfoData.put("timeZoneOffset", Integer.valueOf(TimeZone.getDefault().getOffset(System.currentTimeMillis()) / UnityAdsConstants.RequestPolicy.RETRY_MAX_INTERVAL));
        try {
