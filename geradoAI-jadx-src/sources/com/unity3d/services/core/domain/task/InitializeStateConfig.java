...
public final class InitializeStateConfig extends MetricTask<Params, Configuration> {
    ...
    public InitializeStateConfig(ISDKDispatchers iSDKDispatchers, InitializeStateConfigWithLoader initializeStateConfigWithLoader) {
        ...
        k90.m5749e(initializeStateConfigWithLoader, "initializeStateConfigWithLoader");
    ...
    public /* bridge */ /* synthetic */ Object mo10916doWorkgIAlus(BaseParams baseParams, InterfaceC2577xj interfaceC2577xj) {
        return m10924doWorkgIAlus((Params) baseParams, (InterfaceC2577xj<? super lu0<? extends Configuration>>) interfaceC2577xj);
    }
    ...
    public Object m10924doWorkgIAlus(Params params, InterfaceC2577xj<? super lu0<? extends Configuration>> interfaceC2577xj) {
        InitializeStateConfig$doWork$1 initializeStateConfig$doWork$1;
        if (interfaceC2577xj instanceof InitializeStateConfig$doWork$1) {
            initializeStateConfig$doWork$1 = (InitializeStateConfig$doWork$1) interfaceC2577xj;
            int i = initializeStateConfig$doWork$1.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                initializeStateConfig$doWork$1.label = i - Integer.MIN_VALUE;
            } else {
                initializeStateConfig$doWork$1 = new InitializeStateConfig$doWork$1(this, interfaceC2577xj);
            }
        } else {
            initializeStateConfig$doWork$1 = new InitializeStateConfig$doWork$1(this, interfaceC2577xj);
        }
        Object objM10602C = initializeStateConfig$doWork$1.result;
        EnumC2347tk enumC2347tk = EnumC2347tk.f19307j;
        int i2 = initializeStateConfig$doWork$1.label;
        if (i2 == 0) {
            ...
            objM10602C = z80.m10602C(abstractC1929lk, initializeStateConfig$doWork$2, initializeStateConfig$doWork$1);
