...
public final class UnityAdsSDK$getToken$$inlined$inject$default$1 extends nb0 implements g10<GetAsyncHeaderBiddingToken> {
    ...
    public final GetAsyncHeaderBiddingToken invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, qs0.m7995a(GetAsyncHeaderBiddingToken.class));
    }
}
