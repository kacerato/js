...
public final class UnityAdsSDK$fetchToken$$inlined$inject$default$2 extends nb0 implements g10<GetInitializationState> {
    ...
    public final GetInitializationState invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, qs0.m7995a(GetInitializationState.class));
    }
}
