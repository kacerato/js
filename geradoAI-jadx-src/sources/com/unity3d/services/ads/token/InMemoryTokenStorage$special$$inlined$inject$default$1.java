...
public final class InMemoryTokenStorage$special$$inlined$inject$default$1 extends nb0 implements g10<AsyncTokenStorage> {
    ...
    public final AsyncTokenStorage invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, qs0.m7995a(AsyncTokenStorage.class));
    }
}
