...
public final class UnityAdsSDK$finishOMIDSession$$inlined$inject$default$1 extends nb0 implements g10<GetAdObject> {
    ...
    public final GetAdObject invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, qs0.m7995a(GetAdObject.class));
    }
}
