...
public final class UnityAdsSDK$initialize$$inlined$inject$default$3 extends nb0 implements g10<InitializeSDK> {
    ...
    public final InitializeSDK invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, qs0.m7995a(InitializeSDK.class));
    }
}
