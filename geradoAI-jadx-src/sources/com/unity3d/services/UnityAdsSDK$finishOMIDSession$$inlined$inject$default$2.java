...
public final class UnityAdsSDK$finishOMIDSession$$inlined$inject$default$2 extends nb0 implements g10<OmFinishSession> {
    final /* synthetic */ String $named;
    final /* synthetic */ IServiceComponent $this_inject;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UnityAdsSDK$finishOMIDSession$$inlined$inject$default$2(IServiceComponent iServiceComponent, String str) {
        super(0);
    ...
    public final OmFinishSession invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, qs0.m7995a(OmFinishSession.class));
    }
}
