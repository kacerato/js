...
public class LazyFieldLite {
    ...
    public void writeTo(Writer writer, int i) {
        if (this.memoizedBytes != null) {
            ((C0310e) writer).m924b(i, this.memoizedBytes);
            return;
        }
        ByteString byteString = this.delayedBytes;
        if (byteString != null) {
            ((C0310e) writer).m924b(i, byteString);
        } else if (this.value != null) {
            ((C0310e) writer).f1641a.writeMessage(i, this.value);
        } else {
            ((C0310e) writer).m924b(i, ByteString.EMPTY);
        }
    }
