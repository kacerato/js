...
public final class zzbp {
    ...
    public static List zzb(JsonReader jsonReader) throws IOException {
    ...
    public static Map zzc(JsonReader jsonReader) throws IOException {
            ...
            if (objOpt != null) {
                if (objOpt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        if (objOpt2 == null) {
                            com.google.android.gms.ads.internal.util.client.zzo.zzi("Expected JSONArray with at least 1 non-null element for key:".concat(String.valueOf(next)));
                            ...
                            com.google.android.gms.ads.internal.util.client.zzo.zzi("JSONArray with unsupported type " + objOpt2.getClass().getCanonicalName() + " for key:" + next);
                        }
                    }
                } else if (objOpt instanceof JSONObject) {
                    bundle.putBundle(next, zzl((JSONObject) objOpt));
                } else {
                    com.google.android.gms.ads.internal.util.client.zzo.zzi("Unsupported type for key:".concat(String.valueOf(next)));
                }
            }
        }
        return bundle;
    ...
    public static String zzm(eo4 eo4Var) {
        if (eo4Var == null) {
            return null;
        }
