...
final class zzan extends zzax {
    ...
    public zzan(zzaw zzawVar, Context context, zzr zzrVar, String str, d23 d23Var) {
        this.zza = context;
        this.zzb = zzrVar;
        this.zzc = str;
        this.zzd = d23Var;
    ...
    public final Object zzc(zzco zzcoVar) {
        return zzcoVar.zzc(new qj0(this.zza), this.zzb, this.zzc, this.zzd, ModuleDescriptor.MODULE_VERSION);
    }
}
