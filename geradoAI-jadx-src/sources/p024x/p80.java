...
public final class p80 extends InputConnectionWrapper {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ C2258rs f14831a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public p80(InputConnection inputConnection, C2258rs c2258rs) {
        super(inputConnection, false);
        this.f14831a = c2258rs;
    }
    ...
    public final boolean performPrivateCommand(String str, Bundle bundle) throws Throwable {
        ...
        C2258rs c2258rs = this.f14831a;
        boolean zM8310b = false;
        zM8310b = false;
        zM8310b = false;
        zM8310b = false;
        if (bundle != null) {
            ...
            try {
                ...
                try {
                    ...
                    if (uri != null && clipDescription != null) {
                        zM8310b = c2258rs.m8310b(new q80(uri, clipDescription, uri2), i, bundle2);
                    }
                    if (resultReceiver != null) {
                        resultReceiver.send(zM8310b ? 1 : 0, null);
                    }
                } catch (Throwable th) {
                    th = th;
                    if (resultReceiver != null) {
