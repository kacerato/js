...
public final class no4 {
    ...
    public final vh2 f13548a;

    public no4(vh2 vh2Var) {
        this.f13548a = vh2Var;
    }

    /* JADX INFO: renamed from: b */
    public static final Uri m6865b(Uri uri, String str) throws wh2 {
        if (uri != null) {
            try {
                try {
    ...
    /* JADX INFO: renamed from: a */
    public final Uri m6866a(Uri uri, Context context, View view, Activity activity) throws wh2 {
        try {
            return m6865b(uri, this.f13548a.f20819b.zzf(context, uri.getQueryParameter("ai"), view, activity));
        } catch (UnsupportedOperationException unused) {
            throw new wh2("Provided Uri is not in a valid state");
        }
    }
