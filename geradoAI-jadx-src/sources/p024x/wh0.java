...
public final class wh0 extends AbstractC2345ti<ai0> {

    /* JADX INFO: renamed from: b */
    public final int f21587b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public wh0(AbstractC2520wi<ai0> abstractC2520wi) {
    ...
    public final boolean mo4142b(pj1 pj1Var) {
        return pj1Var.f15075j.f2863a == ei0.f6462k;
    }
    ...
    public final boolean mo4143c(ai0 ai0Var) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return (z && ai0Var2.f2846b) ? false : true;
        }
        return !z;
    }
}
