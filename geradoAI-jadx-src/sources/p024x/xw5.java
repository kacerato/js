...
public final class xw5 implements yi5 {

    /* JADX INFO: renamed from: g */
    public static final byte[] f22792g = new byte[0];

    /* JADX INFO: renamed from: h */
    public static final byte[] f22793h = {0};

    /* JADX INFO: renamed from: i */
    public static final cn5 f22794i;

    /* JADX INFO: renamed from: j */
    public static final cn5 f22795j;

    /* JADX INFO: renamed from: k */
    public static final cn5 f22796k;

    /* JADX INFO: renamed from: a */
    public final ECPublicKey f22797a;

    /* JADX INFO: renamed from: b */
    public final String f22798b;

    /* JADX INFO: renamed from: c */
    public final xx5 f22799c;

    /* JADX INFO: renamed from: d */
    public final byte[] f22800d;

    /* JADX INFO: renamed from: e */
    public final byte[] f22801e;

    /* JADX INFO: renamed from: f */
    public final Provider f22802f;

    static {
        HashMap map = new HashMap();
        HashMap map2 = new HashMap();
        lk5 lk5Var = lk5.f11728f;
        ly5 ly5Var = ly5.f11990j;
        map.put(ly5Var, lk5Var);
        map2.put(lk5Var, ly5Var);
        lk5 lk5Var2 = lk5.f11729g;
        ly5 ly5Var2 = ly5.f11991k;
        map.put(ly5Var2, lk5Var2);
        map2.put(lk5Var2, ly5Var2);
        lk5 lk5Var3 = lk5.f11730h;
        ly5 ly5Var3 = ly5.f11992l;
        map.put(ly5Var3, lk5Var3);
        map2.put(lk5Var3, ly5Var3);
        f22794i = new cn5(Collections.unmodifiableMap(map), Collections.unmodifiableMap(map2));
        HashMap map3 = new HashMap();
        HashMap map4 = new HashMap();
        mj5 mj5Var = mj5.f12448h;
        xx5 xx5Var = xx5.f22832j;
        map3.put(xx5Var, mj5Var);
        map4.put(mj5Var, xx5Var);
        mj5 mj5Var2 = mj5.f12449i;
        xx5 xx5Var2 = xx5.f22833k;
        map3.put(xx5Var2, mj5Var2);
        map4.put(mj5Var2, xx5Var2);
        f22795j = new cn5(Collections.unmodifiableMap(map3), Collections.unmodifiableMap(map4));
        HashMap map5 = new HashMap();
        HashMap map6 = new HashMap();
        fv5 fv5Var = fv5.f7498c;
        wx5 wx5Var = wx5.f21954j;
        map5.put(wx5Var, fv5Var);
        map6.put(fv5Var, wx5Var);
        fv5 fv5Var2 = fv5.f7499d;
        wx5 wx5Var2 = wx5.f21955k;
        map5.put(wx5Var2, fv5Var2);
        map6.put(fv5Var2, wx5Var2);
        fv5 fv5Var3 = fv5.f7500e;
        wx5 wx5Var3 = wx5.f21956l;
        map5.put(wx5Var3, fv5Var3);
        map6.put(fv5Var3, wx5Var3);
        f22796k = new cn5(Collections.unmodifiableMap(map5), Collections.unmodifiableMap(map6));
    }

    public xw5(ECPublicKey eCPublicKey, ly5 ly5Var, xx5 xx5Var, byte[] bArr, byte[] bArr2, Provider provider) throws GeneralSecurityException {
        if (!x13.m9999k(2)) {
            throw new GeneralSecurityException("Can not use ECDSA in FIPS-mode, as BoringCrypto is not available.");
        }
        vy5.m9653b(ly5Var);
        this.f22798b = ly5Var.toString().concat("withECDSA");
        this.f22797a = eCPublicKey;
        this.f22799c = xx5Var;
        this.f22800d = bArr;
        this.f22801e = bArr2;
        this.f22802f = provider;
    }
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r2v5 ??, new type: int
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r3v5 ??, new type: int
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r5v3 ??, new type: int
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
    ...
    /*  JADX ERROR: Types fix failed
        ...
        */
    /* JADX INFO: renamed from: a */
    public final void m10253a(byte[] r18, byte[] r19) throws java.security.GeneralSecurityException {
        /*
            Method dump skipped, instruction units count: 325
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: p024x.xw5.m10253a(byte[], byte[]):void");
    }

    @Override // p024x.yi5
    /* JADX INFO: renamed from: b */
    public final void mo2796b(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        byte[] bArr3 = this.f22800d;
        ...
        if (length == 0) {
            ...
            m10253a(Arrays.copyOfRange(bArr, length, bArr.length), bArr2);
        }
    }
}
