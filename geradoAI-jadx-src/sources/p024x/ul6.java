...
public final class ul6 {
    static {
        if (ql6.f16996e && ql6.f16995d) {
            int i = hg6.f8665a;
        }
    }

    /* JADX INFO: renamed from: a */
    public static int m9229a(String str, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int i5;
        char cCharAt;
    ...
    public static int m9230b(String str) {
        int length = str.length();
        int i = 0;
        int i2 = 0;
