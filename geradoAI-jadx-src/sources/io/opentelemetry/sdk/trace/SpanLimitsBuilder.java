...
public final class SpanLimitsBuilder {
    ...
    public SpanLimitsBuilder setMaxNumberOfAttributesPerEvent(int i) {
        Utils.checkArgument(i >= 0, "maxNumberOfAttributesPerEvent must be non-negative");
        this.maxNumAttributesPerEvent = i;
        return this;
    }

    public SpanLimitsBuilder setMaxNumberOfAttributesPerLink(int i) {
        Utils.checkArgument(i >= 0, "maxNumberOfAttributesPerLink must be non-negative");
        this.maxNumAttributesPerLink = i;
        return this;
    }

    public SpanLimitsBuilder setMaxNumberOfEvents(int i) {
        Utils.checkArgument(i >= 0, "maxNumberOfEvents must be non-negative");
        this.maxNumEvents = i;
        return this;
    }

    public SpanLimitsBuilder setMaxNumberOfLinks(int i) {
        Utils.checkArgument(i >= 0, "maxNumberOfLinks must be non-negative");
        this.maxNumLinks = i;
        return this;
    }
}
