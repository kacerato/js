...
public abstract class ImmutableKeyValuePairs<K, V> {
    ...
    private static <K> int compareToNullSafe(K k, K k2, Comparator<K> comparator) {
        if (k == null) {
            return k2 == null ? 0 : -1;
        }
        if (k2 == null) {
    ...
    public int hashCode() {
        ...
        int iHashCode = Arrays.hashCode(this.data) ^ 1000003;
    ...
    public String toString() {
        ...
        while (true) {
            ...
            String strM6653f = obj instanceof String ? C2005n1.m6653f(new StringBuilder("\""), (String) obj, '\"') : obj.toString();
