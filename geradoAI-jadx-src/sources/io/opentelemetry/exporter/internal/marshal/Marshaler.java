...
public abstract class Marshaler {
    ...
    public final void writeJsonTo(OutputStream outputStream) {
    ...
    public final void writeJsonToGenerator(JsonGenerator jsonGenerator) {
    ...
    public final void writeJsonWithNewline(JsonGenerator jsonGenerator) {
        JsonSerializer jsonSerializer = new JsonSerializer(jsonGenerator);
        try {
            jsonSerializer.writeMessageValue(this);
    ...
    public abstract void writeTo(Serializer serializer);
}
