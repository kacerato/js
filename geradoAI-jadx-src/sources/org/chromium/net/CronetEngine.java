...
public abstract class CronetEngine {
    ...
    public static class Builder {
        ...
        /* JADX INFO: renamed from: org.chromium.net.CronetEngine$Builder$a */
        public static class C1297a implements Comparator<CronetProvider> {
        ...
        public static List<CronetProvider> getEnabledCronetProviders(Context context, List<CronetProvider> list) {
            ...
            Collections.sort(list, new C1297a());
            return list;
        }
